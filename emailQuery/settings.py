"""
Django settings for emailQueries project.
...
SECRET_KEY = 'django-insecure-jb91#sqcofcv)!ta$xx_8&t+n=@1t8%96rm2sh1!+l&9t=wzwv'
...
ROOT_URLCONF = 'emailQueries.urls'
...
WSGI_APPLICATION = 'emailQueries.wsgi.application'
